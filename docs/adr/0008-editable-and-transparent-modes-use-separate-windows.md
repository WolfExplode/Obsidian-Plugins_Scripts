...
A live editable Excalidraw Board and a genuinely transparent native surface cannot currently be combined reliably within Obsidian's Popout construction path. The attempted renderer, BrowserWindow, BaseWindow, and WebContentsView routes are recorded in ADR 0007 and [`transparent-popout-investigation.md`](../investigations/transparent-popout-investigation.md).
